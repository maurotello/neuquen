...
/**********************/
      $(document).ready(function()
      {
        ...
        var fechaEnvioBcoNuevoSujeto = new Pikaday(
        {
        field: document.getElementById('fecha_envio_banco_nuevo_sujeto'),
        })

        var fechaEnvioBcoNuevoSujeto = new Pikaday(
        {
        field: document.getElementById('fecha_respuesta_banco_nuevo_sujeto'),
        })
        ...
        modal.find('#proyecto_id').val(recipient)
            ...
            /*
                $('#editDesembolso').on('show.bs.modal', function (event) {
                  var button = $(event.relatedTarget)
                  var recipient = button.data('whatever')
                  var modal = $(this)
