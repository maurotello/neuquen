...
<div class="row">
    <div class="form-group col-sm-11">
        ...
        <input type="text" id="proyecto_nombre" class="form-control" name="proyecto_nombre" value="{{ $proyectos->nombre  }}" disabled />
        <input style="visibility:hidden" type="text" id="proyecto_id" class="form-control" name="proyecto_id" value="{{ $proyectos->id }}" />
        <input style="visibility:hidden" type="text" id="estado" class="form-control" name="estado" value="{{ $estado }}" />
